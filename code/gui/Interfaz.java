 ...
 * Interfaz.java
 *
 * Created on 27-01-2011, 04:04:43 PM
 */

package code.gui;

import code.model.cam.VCam;
import code.model.cam.gadgets.VCamGadget;
import code.model.cam.gadgets.videotracker.VTracker;
...
{
    private VDrumKit bateria;
    private VCam cam;

    public Interfaz()
    {
        bateria=new VDrumKit();
        ArrayList<VCamGadget> gadgets = new ArrayList<VCamGadget>();
        gadgets.add(new VTracker());
        cam = new VCam(gadgets);
        ...
        initComponents();
        //videotrackerFrame.pack();
        //videotrackerFrame.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("No song loaded");
        ...
        jTextField1.setText("Type here to begin");
        ...
        jTabbedPane1.addTab("Standard", jPanel2);
        ...
        jTabbedPane1.addTab("Professional", jPanel4);
        ...
        jTabbedPane1.addTab("Custom", jPanel5);
